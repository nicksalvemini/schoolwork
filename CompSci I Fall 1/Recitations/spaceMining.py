...
def visit_from_moon(drills, shovels, dozers):
    ...
    # global MOON_BONUS
    cerium = visit_mercury(drills)
    cerium_space_rocks = cerium * 2 + MOON_BONUS


    # visit venus.  the amount of space rocks obtained
    # is the amount of yttrium plus 3 plus the MOON_BONUS
    yttrium = visit_venus(drills,shovels)
    yttrium_space_rocks = yttrium + 3 + MOON_BONUS


    # visit mars.  the amount of space rocks obtained
    # is integer divided by 2 plus the MOON_BONUS
    scandium = visit_mars(drills,dozers)
    scandium_space_rocks = scandium // 2 + MOON_BONUS

    space_rocks = cerium_space_rocks + yttrium_space_rocks + scandium_space_rocks


    # display the total yield from the moon
    display_elements("Moon", cerium, yttrium, scandium, space_rocks)
