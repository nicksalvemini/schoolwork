...
public class ToyLand {
    ...
    public void playTime() {
        while(activeToys.size() > 0){
            IToy currentToy = activeToys.remove(0);
    ...
    public void displayStatistics() {
        ...
        System.out.println("Total number of toys: " + retiredToys.size());
        System.out.println("Total happiness of all toys: " + totalHappiness);
        System.out.println("Average wear of all toys: " + (totalWear / retiredToys.size()));
    }
